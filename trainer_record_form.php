...
class trainer_record_form extends moodleform {
    function definition() {
        ...
        $mform->addElement('html', '</div>');
            ...
            array('optional' => false), array('id' => 'datepicker'));
        ...
        // buttons
        $this->add_action_buttons(true, get_string('submitdata', 'local_trainer_record'));
